# kubectl-oke-bastion — agent instructions

## Agent skills

### Issue tracker

Issues and PRDs live as GitHub issues in `origoss-labs/kubectl-oke-bastion` (use the `gh` CLI). See `docs/agents/issue-tracker.md`.
